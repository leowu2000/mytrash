...
<table border="0" align="center" width="100%" cellspacing="1" bgcolor="#CCCCCC">
	<tr>
		...
		<td  bgcolor="#FFFFFF"><input type="text" name="RZ" value="<%=bean.getRZ() %>" size="8"/>米</td>
		<td nowrap class="title">当前库容:</td>
		<td bgcolor="#FFFFFF" ><input type="text" name="RV" value="<%=bean.getRV() %>" size="8"/>万立方米</td>
		
	</tr>
	<tr>
		<td nowrap class="title">当前泻量:</td>
		<td bgcolor="#FFFFFF" colspan="5"><input type="text" name="RQ" value="<%=bean.getRQ() %>" size="8"/>立方米/秒</td>
	</tr>
</table>
</div>
</body>
