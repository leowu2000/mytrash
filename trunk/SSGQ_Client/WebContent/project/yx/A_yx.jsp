...
<table border="0" align="center" width="100%" cellspacing="1" bgcolor="#CCCCCC">
	...
	<tr>
		...
		<td bgcolor="#FFFFFF" ><input type="text" name="RQ" value="<%=bean.getRQ() %>" size="8"/> 立方米/秒</td>
		<td nowrap class="title">水面距堤顶距离:</td>
		<td bgcolor="#FFFFFF"><input type="text" name="WSTODC" value="<%=bean.getWSTODC() %>" size="8"/> 米</td>
	</tr>
</table>
</div>
</body>
