...
public class DetailBean {
	...
	private String DSSPN="";		//受灾人口(人)			==D001==D015==D026
	private String INPN="";		//受伤人口(人)			==D001==D015
	private String DTHPN="";		//死亡人口(人)			==D001==D015==D026
	private String WRHS="";		//倒塌房屋(间)			==D001==D015==D026
	private String CRPDSSAR="";	//农作物受灾面积(公顷)	==D001==D015
	private String SCDMFMAR="";	//毁坏耕地面积(公顷)		==D001==D015
	private String DRCECLS="";		//直接经济损失(万元)		==D001==D015==D026
	...
	//==D026	山洪灾害		B_TORRENTSt
	private String DSSAREA=""; 	//受灾面积
	private String DAYDP="";	//日最大降雨量
	private String TDP = "";	//时段最大降雨量
	private String DSSTP = "";	//灾害类型
	
	
	
	public String getDSSAREA() {
		return DSSAREA;
	}

	public void setDSSAREA(String dSSAREA) {
		DSSAREA = dSSAREA;
	}

	public String getDAYDP() {
		return DAYDP;
	}

	public void setDAYDP(String dAYDP) {
		DAYDP = dAYDP;
	}
	...
	public String getDSSTP() {
		return DSSTP;
	}

	public void setDSSTP(String dSSTP) {
		DSSTP = dSSTP;
	}
	...
	public static DetailBean getDetailBeanFromRs(ResultSet rs,String XQFL){
		...
		try{
			...
			if("D026".trim().equals(XQFL)){
				...
				bean.setDSSPN(String.valueOf(rs.getInt("DSSPN")));
				bean.setDSSAREA(String.valueOf(rs.getFloat("DSSAREA")));
				bean.setDTHPN(String.valueOf(rs.getInt("DTHPN")));
				bean.setWRHS(String.valueOf(rs.getFloat("WRHS")));
				bean.setDRCECLS(String.valueOf(rs.getFloat("DRCECLS")));
				bean.setDAYDP(String.valueOf(rs.getFloat("DAYDP")));
				bean.setTDP(String.valueOf(rs.getFloat("TDP")));
				bean.setDSSTP(rs.getString("DSSTP"));
			}
		}catch(Exception ex){
			ex.printStackTrace();
			}
