...
<%
	for(int i=0;i<listHq_m.size();i++){
	    ...
	    String ext = mapHq_m.get("WJGS")==null?"":mapHq_m.get("WJGS").toString().trim().toUpperCase();
%>
	<tr width="100%">
	  <td>
		<table width="100%">
