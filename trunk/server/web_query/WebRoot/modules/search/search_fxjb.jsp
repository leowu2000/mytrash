  ...
  <div id="query" > 
    ...
    <table width="98%" border="0" cellspacing="1" bgcolor="#336699" class="font_define">
      <tr> 
        ...
        <td bgcolor="#FFFFFF" align="left"> <input name="text_title" id="text_title" class="input2" > 
        </td>
        <td align="center"><font color="#FFFFFF">填报单位</font></td>
        <td bgcolor="#FFFFFF" align="left"> <input name="text_fill" id="text_fill" class="input2" > 
        </td>
