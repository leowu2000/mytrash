...
<form name="fxxq" id="fxxq" method="post" onsubmit="return checkall() " action="/search.do?action=zq" target="result">
  <div id="query" > 
    ...
    <table width="98%" border="0" cellspacing="1" bgcolor="#336699" class="font_define">
      <tr align="center"> 
        ...
        <td align="left" bgcolor="#FFFFFF">
			从<input type="text" id="date_start" name="date_start" class="input2" onClick="WdatePicker({readOnly:true})">到
