...
<body topmargin="3" >
<form name="fxxq" method="post" action="result_multCond.asp?command=9" target="result">
  <div id="query" > 
    <table width="98%" border="0" align="left" cellpadding="2" cellspacing="1" bgcolor="#336699">
      ...
      <tr align="center"> 
        ...
        <td colspan="3" align="left" bgcolor="#FFFFFF"><script src="../script/shijian.js" language="javascript"></script></td>
      </tr>
      <tr align="center"> 
