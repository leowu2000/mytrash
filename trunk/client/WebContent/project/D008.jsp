...
<table border="0" align="center" width="100%" cellspacing="1" bgcolor="#CCCCCC">
	<tr height="25" >
		...
		<td bgcolor="#FFFFFF"><input type="text" name="CRD" value="<%=bean.getCRD() %>" size="8"/>米<font color="red">*</font></td>
	<tr height="25" >
		<td nowrap class="title">裂缝长度:</td>
		<td bgcolor="#FFFFFF">
		<input type="text" name="CRL" value="<%=bean.getCRL() %>"/>米<font color="red">*</font></td>
		<td nowrap class="title">裂缝宽度:</td>
		<td bgcolor="#FFFFFF">
		<input type="text" name="CRW" value="<%=bean.getCRW() %>"/>米<font color="red">*</font></td>
	</tr>
</table>
</div>
</body>
