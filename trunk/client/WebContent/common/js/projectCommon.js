...
function per_Submit(type){
	...
	if(radioValue==2){//工程险情
		...
		document.frm.BJWHZK.value=window("main3").document.getElementById("BJWHZK").value;//坝基完好状况
		document.frm.BTWDZK.value=window("main3").document.getElementById("BTWDZK").value;//坝体稳定状况
		document.frm.HPHAWDQK.value=window("main3").document.getElementById("HPHAWDQK").value;//护坡护岸稳定情况
		document.frm.TXSDJZK.value=window("main3").document.getElementById("TXSDJZK").value;//通讯手段及状况
		document.frm.XSJZWZK.value=window("main3").document.getElementById("XSJZWZK").value;//泄水建筑物状况
		document.frm.XNGWHZK.value=window("main3").document.getElementById("XNGWHZK").value;//泄能工完好状况
		document.frm.ZMQBJZK.value=window("main3").document.getElementById("ZMQBJZK").value;//闸门、起闭机状况
	}
