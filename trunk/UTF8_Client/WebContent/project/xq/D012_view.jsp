...
<table border="0" align="center" width="100%" cellspacing="1" bgcolor="#CCCCCC">
	<tr>
		...
		<td  bgcolor="#FFFFFF"> <%=bean.getSLUPAG() %> 度</td>
		<td class="title"  height="25">滑动位移</td>
		<td  bgcolor="#FFFFFF"> <%=bean.getSLUDSP() %> 米</td>
		<td class="title"  height="25">滑动类型</td>
		<td  bgcolor="#FFFFFF" > <%=bean.getSLUTP() %> </td>
	</tr>
	<tr>
		<td nowrap class="title" >滑动面地质情况</td>
		<td  bgcolor="#FFFFFF" colspan="5"> <%=bean.getSLUGLCN() %> </td>
	</tr>
