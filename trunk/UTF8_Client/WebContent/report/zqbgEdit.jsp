...
<table border="0" align="center" width="98%" cellspacing="1" bgcolor="#CCCCCC">
	...
	<tr height="25" >
		...
		<iframe id="ZPFRAME" frameborder="0" scrolling="yes" marginwidth="0" marginheight="0"  src="/common/pic.jsp?temp= <%=Math.random()%>&tablename=TB_SD_M&pkvalue=<%=RPJINCD %>&pkname=RPJINCD&from=edit" height="110" width="100%">
		</iframe>	
		</td> 
	</tr>
	<tr height="25" >
