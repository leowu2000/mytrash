...
<% 
	...
	List<FPACTIBean> records = BuinessDao.getAllFpactiList(path); 
...
<table border="0" align="center" width="100%" cellspacing="1" bgcolor="#CCCCCC">
	<tr bgcolor="#E8EFFF" height="30" >
		...
		<td nowrap align="center" class="title_center">行动标题</td>
	...
	<tr  bgcolor="#FFFFFF">
		...
		<td><a href="fxxdView.jsp?RPJINCD=<%=bean.getRPJINCD() %>" title="点击查看详细信息"><%=bean.getWTTT()%></a></td>
