...
<body scroll="auto" onload="loadSelect()">
...
<table border="0" align="center" width="90%" cellspacing="1" bgcolor="#CCCCCC">
	...
	<tr height="25" >
		...
		<td bgcolor="#FFFFFF"><input type="text" name="SERVER_PORT" value="<%=bean.getSERVER_PORT()==null?"":bean.getSERVER_PORT() %>"/><font color="red">*</font></td>
	</tr>
</table>
</form>
<br/>
