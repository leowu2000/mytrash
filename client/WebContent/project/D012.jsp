...
<table border="0" align="center" width="100%" cellspacing="1" bgcolor="#CCCCCC">
	<tr>
		...
		<td  bgcolor="#FFFFFF"><input type="text" name="SLUPAG" value="<%=bean.getSLUPAG() %>" size="8"/>度</td>
		<td class="title"  height="25">滑动位移</td>
		<td  bgcolor="#FFFFFF"><input type="text" name="SLUDSP" value="<%=bean.getSLUDSP() %>" size="8"/>米</td>
		<td class="title"  height="25">滑动类型</td>
		<td  bgcolor="#FFFFFF" ><input type="text" name="SLUTP" value="<%=bean.getSLUTP() %>" size="8"/></td>
	</tr>
	<tr>
