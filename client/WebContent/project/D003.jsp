...
<table border="0" align="center" height="30" width="100%" cellspacing="1" bgcolor="#CCCCCC">
	<tr height="25" >
		...
		<td bgcolor="#FFFFFF"><input type="text" name="LKDMT" value="<%=bean.getLKDMT() %>" size="8"/>米<font color="red">*</font></td>
		<td nowrap class="title">漏洞流量:</td>
		<td bgcolor="#FFFFFF" ><input type="text" name="LKQ" value="<%=bean.getLKQ() %>"/>升/秒<font color="red">*</font></td>
	...
	<tr height="25" >
		...
		<td bgcolor="#FFFFFF" colspan="4"><input type="text" size="8" name="LKSAR" value="<%=bean.getLKSAR() %>"/>平方米<font color="red">*</font></td>
