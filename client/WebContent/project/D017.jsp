...
<table border="0" align="center" height="30" width="100%" cellspacing="1" bgcolor="#CCCCCC">
	<tr>
		...
		<td  bgcolor="#FFFFFF"><input type="text" name="MXTNST" value="<%=bean.getMXTNST() %>" />牛/平方毫米</td>
		<td class="title" height="25">最大压应力</td>
		<td  bgcolor="#FFFFFF"><input type="text" name="MXCMST" value="<%=bean.getMXCMST() %>" />牛/平方毫米</td>
	</tr>
	<tr>
		...
		<td  bgcolor="#FFFFFF"><input type="text" name="ASTR" value="<%=bean.getASTR() %>" />牛/平方毫米</td>
