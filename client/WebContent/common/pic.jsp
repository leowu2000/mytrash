...
<% 
	...
	while (rs.next()) {
		...
		String filename = picpath+"\\\\common\\\\pic\\\\"+zlcode+"_"+current+"_demo.jpg";
		String picname = zlcode+"_"+current+"_demo.jpg";
