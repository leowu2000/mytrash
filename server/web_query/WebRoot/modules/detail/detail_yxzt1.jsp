...
<form name="form1" method="post" action="../interface/result_yxzt.asp" target="result"> 
  ...
  <table width='70%' border='0'  align='center' cellpadding='0' cellspacing='1' bgcolor='#336699' >
<%
	if("B".equals(gcfldm)){//水库
%>
  	  <tr align='center'>
		<td width='15%' height='25' class="banner">水库类别</td>
		<td width='35%' height='25' bgcolor='#FFFFFF' ><font color=#000000 id='lable21'><%=mapGcflxx.get("RSCLS")==null?"":mapGcflxx.get("RSCLS")%></font></td>        
		<td width='15%' height='25' class="banner">当前库容</td>
...
%>
	  <tr align='center'>
  	  ...
  	  <tr align='center'>
		<td height='25' class="banner">建筑物完好状况</td>
...
%>
	  <tr align='center'>
		<td width='15%' height='25' class="banner">所在岸别</td>
		<td width='35%' height='25' bgcolor='#FFFFFF' ><font color=#000000 id='lable21'><%=mapGcflxx.get("BKOT")==null?"":mapGcflxx.get("BKOT")%></font></td>
		<td width='15%' height='25' class="banner">水流情况描述</td>
...
%>
	  <tr align='center'>
		<td width='15%' height='25' class="banner">所在岸别</td>
		<td width='35%' height='25' bgcolor='#FFFFFF' ><font color=#000000 id='lable21'><%=mapGcflxx.get("BKOT")==null?"":mapGcflxx.get("BKOT")%></font></td>
		<td width='15%' height='25' class="banner">设计行(蓄)洪水位</td>
