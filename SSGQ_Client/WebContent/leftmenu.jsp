...
<li><a href="#Menu=ChildMenu1"  onclick="DoMenu('ChildMenu1')"><b>数据维护</b></a> 
    ...
    <li><a href="/project/xq/gqxqManage.jsp" target="mainFrame">工程险情</a></li> 
    <li><a href="/project/yx/gqyxManage.jsp" target="mainFrame">工程运行状态</a></li> 
    </ul> 
</li> 
...
<li><a href="#Menu=ChildMenu3" onclick="DoMenu('ChildMenu3')"><b>数据上传</b></a> 
    ...
    <li><a href="/upload.do?actionType=manage" target="mainFrame">数据上传</a></li> 
    </ul> 
</li> 
