...
<!--D026	山洪灾害		TB_CLPJSCDN-->
<input type="hidden" name="DSSTP" value=""/>		<!--冲毁体积(立方米)-->
<input type="hidden" name="DSSAREA" value=""/>		<!--冲毁长度(米)-->
<input type="hidden" name="DAYDP" value=""/>		<!--冲毁处地质情况-->
<input type="hidden" name="TDP" value=""/>		<!--冲毁深度(米)-->
